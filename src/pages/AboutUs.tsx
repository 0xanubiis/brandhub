    ...
    <div className="min-h-screen bg-black">
      ...
      <div className="pt-20">
        <div className="max-w-3xl mx-auto px-2 sm:px-4 lg:px-6 py-10 md:py-16 bg-black/60 backdrop-blur-md rounded-2xl border border-white/10 shadow-lg">
          <h1 className="text-3xl md:text-4xl font-bold text-center mb-8 bg-gradient-to-r from-white via-gray-200 to-gray-400 bg-clip-text text-transparent">
          ...
          <div className="prose prose-invert prose-lg max-w-none text-gray-300">
            ...
            <h2 className="text-xl md:text-2xl font-bold mb-3 bg-gradient-to-r from-white via-gray-200 to-gray-400 bg-clip-text text-transparent">How It Works</h2>
            ...
            <h2 className="text-xl md:text-2xl font-bold mb-3 bg-gradient-to-r from-white via-gray-200 to-gray-400 bg-clip-text text-transparent">Why Partner With Us?</h2>
            ...
            <h2 className="text-xl md:text-2xl font-bold mb-3 bg-gradient-to-r from-white via-gray-200 to-gray-400 bg-clip-text text-transparent">A New Era of Fashion Collaboration</h2>
            <p className="text-base md:text-lg text-gray-400 mb-6">
            ...
            <div className="text-center">
              <p className="text-lg md:text-xl font-bold bg-gradient-to-r from-white via-gray-200 to-gray-400 bg-clip-text text-transparent">
